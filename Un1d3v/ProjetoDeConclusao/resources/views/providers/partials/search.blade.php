                ...
                <form class="row">
                    ...
                    <div class="col-md-3">
                        <div class="d-flex  align-items-center">
                            <input type="email" class="form-control" id="email" name="email" placeholder="E-mail" value="{{ request()->get('email') }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="d-flex  align-items-center">
                    ...
                    <div class="col-md-2">
                        ...
                        <a class="btn btn-warning" href="{{ route('providers.index') }}">Limpar</a>
                    </div>
                </form>
